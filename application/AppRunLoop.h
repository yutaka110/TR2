...
private:
    ...
    uint32_t receiveDisplayFrameId_ = 0;
    double receiveDisplayCameraFrameAgeMs_ = 0.0;
    double receiveDisplayEncoderOutputAgeMs_ = 0.0;
    double receiveDisplayDecodedFrameAgeMs_ = 0.0;
    ...
    bool hasReceiveDisplayCameraFrameAgeMs_ = false;
    bool hasReceiveDisplayEncoderOutputAgeMs_ = false;
    bool hasReceiveDisplayDecodedFrameAgeMs_ = false;
