...
namespace net {
    ...
    struct AdaptiveStreamingInput {
        ...
        uint64_t h264KeyFrameRequestReceiverHardSyncLoss = 0;
    ...
    struct AdaptiveStreamingState {
        ...
        uint64_t lastRecoveryDeadlineRawDelta = 0;
        uint64_t lastRecoveryDeadlineEffectiveDelta = 0;
        uint64_t lastRetransmitStaleRawDelta = 0;
        uint64_t lastRetransmitStaleEffectiveDelta = 0;
        uint64_t lastRecoveryDeadlineNoiseDelta = 0;
        uint64_t lastRecoveryDeadlineSyncRiskDelta = 0;
        uint64_t lastRecoveryDeadlineHardSyncLossDelta = 0;
        bool lastRecoveryDeadlineSyncEvidenceActive = false;
        double lastRecoveryDeadlineSyncEvidenceAgeMs = 0.0;
        std::string lastRecoveryDeadlineSyncEvidenceSource = "none";
    ...
    private:
        ...
        uint64_t lastAckStaleAgeCooldownNoise_ = 0;
        uint64_t lastAckStaleAgeCooldownSyncRisk_ = 0;
        uint64_t lastReceiverDeadlineNackMissingCooldownNoise_ = 0;
        uint64_t lastReceiverDeadlineNackMissingCooldownSyncRisk_ = 0;
        uint64_t lastReceiverTrueSyncLoss_ = 0;
        uint64_t lastReceiverHardSyncLoss_ = 0;
        double recoveryDeadlineSyncEvidenceSec_ = 0.0;
        double recoveryDeadlineSyncEvidenceAgeSec_ = 0.0;
        std::string recoveryDeadlineSyncEvidenceSource_ = "none";
